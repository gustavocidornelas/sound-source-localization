            ...
            beta_left = np.dot(
                ...
                np.array(
                    [
                        ...
                        [
                            coeff_left_k[0]
                            + coeff_left_k[1] * self.a0
                            + coeff_left_k[2] * np.power(self.a0, 2)
                            + coeff_left_k[3] * np.power(self.a0, 3)
                        ],
                        [
                            coeff_left_k[0]
                            + coeff_left_k[1] * self.b0
                            + coeff_left_k[2] * np.power(self.b0, 2)
                            + coeff_left_k[3] * np.power(self.b0, 3)
                        ],
                    ]
                ),
            )
            beta_right = np.dot(
                ...
                np.array(
                    [
                        ...
                        [
                            coeff_right_k[0]
                            + coeff_right_k[1] * self.a0
                            + coeff_right_k[2] * np.power(self.a0, 2)
                            + coeff_right_k[3] * np.power(self.a0, 3)
                        ],
                        [
                            coeff_right_k[0]
                            + coeff_right_k[1] * self.b0
                            + coeff_right_k[2] * np.power(self.b0, 2)
                            + coeff_right_k[3] * np.power(self.b0, 3)
                        ],
                    ]
                ),
            )

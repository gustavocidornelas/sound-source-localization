...
if __name__ == '__main__':
    ...
    for az in azimuths:
        ...
        pathlib.Path(azimuth_data_path + '/Delays threshold method').mkdir(parents=True, exist_ok=True)
        ...
        # save results
        np.save(azimuth_data_path + '/Delays threshold method/ists_threshold_delays_Az_' + str(az) + '.npy', all_delays)

...
if __name__ == '__main__':
    ...
    for az in azimuths:
        ...
        pathlib.Path('Dataset from ISTS/Az_' + str(az)).mkdir(parents=True, exist_ok=True)

        # convolving signals with HRIR
        for i in range(1, 23):
            speech_signal = np.load('/Users/gustavocidornelas/Desktop/sound-source/utils/ists_s' + str(i) + '.npy')
            ...
            np.save('Dataset from ISTS/Az_' + str(az) + '/ists_sig_' + str(i) + '_Az_' + str(az) + '.npy',

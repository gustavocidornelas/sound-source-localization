...
if __name__ == '__main__':
    ...
    np.savetxt(str(onset_model) + "_" + str(onset_decay) + "_" + str(window_model) + "_" + str(window_decay) + "_Az_" +
               str(azimuth) + "_freq_" + str(fc_max) + ".csv", final_LCR, delimiter=",",
    ...
    axs[2].plot(range(LCR_L[30000:].shape[0]), LCR_L[30000:], 'r')
    axs[2].plot(range(LCR_L[30000:].shape[0]), LCR_R[30000:], 'b')
    plt.show()

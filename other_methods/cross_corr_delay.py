...
def estimate_delay_cross_correlation(audio, fs=44.1):
    ...
    fs = fs * 1000
    corr = signal.correlate(audio_L, audio_R, mode="same") / np.sqrt(
        signal.correlate(audio_R, audio_R, mode="same")[int(L / 2)]
...
if __name__ == "__main__":
    ...
    for az in azimuth:
        ...
        pathlib.Path(azimuth_data_path + "/Delays cross-correlation method").mkdir(

...
if __name__ == "__main__":
    ...
    for az in azimuths:
        ...
        pathlib.Path("Dataset from GRID/Az_" + str(az)).mkdir(
        ...
        for id in female_speakers:
            ...
            all_signals = [
                ...
                for file in os.listdir(
                    "/Users/gustavocidornelas/Desktop/sound-source/Data GRID/Female/"
                    + id
                    + "/"
                )
            ...
            fs, speech_signal = wavfile.read(
                "/Users/gustavocidornelas/Desktop/sound-source/Data GRID/"

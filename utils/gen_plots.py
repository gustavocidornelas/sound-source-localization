...
if __name__ == "__main__":
    ...
    audio_data = np.genfromtxt(
        "/Users/gustavocidornelas/Desktop/sound-source/Male_Az_90.csv", delimiter=","
    )
    ...
    lcr = np.genfromtxt(
        "/Users/gustavocidornelas/Desktop/sound-source/gammatone_0.99_exponential_0.996_Az_90.csv"
    )
    L = lcr.shape[0]
    # visualizing the results
    fig, axs = plt.subplots(2)

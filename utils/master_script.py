...
if __name__ == '__main__':
    ...
    for az in range(-90, 100, 10):
        ...
        coeff_left_file = '/Users/gustavocidornelas/Desktop/sound-source/Male\ signal/Poly_Coefficients/coeff_' + \
                           str(float(az)) + '_LEFT.csv'
        coeff_right_file = '/Users/gustavocidornelas/Desktop/sound-source/Male\ signal/Poly_Coefficients/coeff_' + \
                          str(float(az)) + '_RIGHT.csv'

        os.system("python delay_estimation.py " + coeff_left_file + " " + coeff_right_file + " " + str(float(az)))
